...
<html lang="en">
    <head>
        ...
        <title>Sys Control Grupos</title>
    ...
    <body>
         @if (auth()->check())
         <nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color: #245888">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3"  href="{{ route('home') }}">
            <img src="{{ asset('assets/img/ESFElogo.png') }}" alt="Logo" width="50" height="43" class="d-inline-block align-text-top"> ESFE  Grupos
            </a>
            <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color: #0B3D6A">
                    ...
                    <div class="sb-sidenav-footer" style="background-color: #002E58">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Control Grupos 2024</div>
                        </div>
                    </div>
                </footer>
            </div>
